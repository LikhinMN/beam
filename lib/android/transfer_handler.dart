  ...
  static Future<void> handleEvent(TransferEvent event) async {
    ...
    switch (event.status) {
      case TransferEventType.started:
        await BeamForegroundService.updateNotification(
          'Receiving $fileName — 0%',
        );
        break;
      ...
      case TransferEventType.completed:
        ...
        await BeamForegroundService.updateNotification(
          'Beam is ready to receive files',
        );
